...
public class Main {
    ...
    public static ArrayList<Car> rentalCars = FileHandler.readCarsFromFile();
    ...
    //adds test data if files are empty
    public static void addTestData(){
        if ((FileHandler.fileIsEmpty("src/Files/rentalCars.ser")) && (FileHandler.fileIsEmpty("src/Files/customerList.ser")) && (FileHandler.fileIsEmpty("src/Files/rentalContracts.ser"))){
            // Car objects
            ...
            // Add all objects to the ArrayList's
            ...
            System.out.println("Files were empty, test data added to files");
        }
    }
}  